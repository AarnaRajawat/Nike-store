...
const Item = ({ifExists,id,title,text,rating,btn, img,price,color,shadow}) => {
  ...
  <button type="button" className="bg-white opacity-90 button-theme px-2 py-1 shadow shadow-sky-200 text-sm text-black" onClick={() => { onAddToCart(); onCartToggle();}}>{btn}</button>
  </div>
